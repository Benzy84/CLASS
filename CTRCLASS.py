...
def CTR_CLASS(T: torch.Tensor,num_iters = 100,save_path=None,save_name='0',save_every=10000,imsize = None,real=False,device = None):
    ...
    return T.cpu(), O_est, phi_tot.reshape(*imsize[::-1]).T.cpu(), MTF.reshape(*imsize[::-1]).T.cpu().abs()
